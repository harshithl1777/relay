 ...
 * This class updates the end session view model based on the success or failure
 * output data.
 */
public class EndSessionPresenter implements EndSessionOutputBoundary {
	...
	/**
	 * Constructs a new instance of EndSessionPresenter with the provided end
	 * session view model.
	 *
	 ...
	 *
	 * @param endSessionOutputData The output data containing information for the
	 *                             successful end session operation.
