...
public class CreateCourseResponseHandler {
	...
	public ResponseEntity<?> signup(@RequestBody Map<String, Object> requestBody) {
		...
		CreateCourseCourseDataAccessInterface courseDataAccessObject = new FirebaseCourseDataAccessObject();

		CreateCourseController createCourseController = CreateCourseUseCaseFactory.createCreateCourseUseCase(
